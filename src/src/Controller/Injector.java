...
public class Injector {
    ...
    public Injector(){
        ...
        ServiceManagmentProductsImpl serviceManagementProducts = new ServiceManagmentProductsImpl();
        Authenticaion authenticaion = new AuthenticationImpl();
        //создать склад, торговый зал и поставщика
        ...
        showFrameGetSalary.setShop(shop);
        ...
        showOverdueProducts.setShop(shop);
